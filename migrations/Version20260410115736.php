 ...
 */
final class Version20260410115736 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reponse_enquete (id_reponse INT AUTO_INCREMENT NOT NULL, id_enquete INT DEFAULT NULL, id INT DEFAULT NULL, date_creation DATETIME DEFAULT \'current_timestamp()\', moyenne DOUBLE PRECISION DEFAULT \'NULL\', UNIQUE INDEX unique_reponse_client (id_enquete, id), INDEX fk_reponse_user (id), INDEX IDX_5FDF1410845C259 (id_enquete), PRIMARY KEY (id_reponse)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
